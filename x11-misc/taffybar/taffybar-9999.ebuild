...
SRC_URI="https://github.com/ProtonNumber/taffybar/archive/refs/heads/cpuMonitor.zip"
S="${WORKDIR}/taffybar-cpuMonitor"
...
RDEPEND="dev-haskell/ansi-terminal:=[profile?]
	...
	>=dev-haskell/dyre-0.9:=[profile?] <dev-haskell/dyre-0.10:=[profile?]
	...
	>=dev-haskell/gtk-sni-tray-0.1.8.0:=[profile?]
